...
if [ $# -ne 5 ]
then
    echo "Unexpected number of arguments: please give (1) which feature set to use (\"bagofwords\", \"rares\", \"trigram\"), (2) the training label file, (3) the test label file, (4) the directory of recipe files, and (5) the file for saving the trained model."
    exit 2
fi
